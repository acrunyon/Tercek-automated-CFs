...
## ----user-inputs-1, warning=FALSE, include = FALSE----------------------------
...
local_rss_dir <- './' # local directory where you want this repo copied. Should be something like 'C:/Users/adillon/Documents/RSS/'. Next lines create folder for park
...
## ----site-info, message=FALSE, warning=FALSE, include = FALSE, error = TRUE-----------------
...
## ----user-inputs-2, warning=FALSE, include = FALSE----------------------------
...
## ----Climate-Futures, message=FALSE, warning=FALSE, include = FALSE-----------
...
## ----Copy-and-delete-files, message=FALSE, warning=FALSE, include = FALSE-----
