...
ggsave("TminF-TmaxF-Panel.png",legend, path = FigDir, height=PanelHeight, width=PanelWidth,bg="white")
...
ggsave("OverHotTemp-HI.Dan-Panel.jpg", path = FigDir, height=PanelHeight, width=PanelWidth,bg="white")
...
a <- ggplot(allregressions, aes(x=return, y=GEV, group=CF, colour = CF)) +
  ...
  PlotTheme + theme(axis.title.x=element_text(size=23, vjust=0.5,  margin=margin(t=20, r=20, b=20, l=20))) +
...
ggsave("Recurrenceinterval-Runoff.in-Panel.png",legend, path = FigDir, height=PanelHeight, width=PanelWidth,bg="white")
...
a <- a+ theme(legend.title=element_text(size=12),legend.text=element_text(size=14),legend.position = "bottom", legend.spacing.x = unit(0.5, 'cm'))
b <- b+ theme(legend.title=element_text(size=12),legend.text=element_text(size=14),legend.position = "bottom", legend.spacing.x = unit(0.5, 'cm'))
  
legend <- grid_arrange_shared_legend(a,b,nrow=2,ncol=1,position="bottom")
ggsave("Panel-D.in-WaterBalance.png",legend, path = FigDir, height=PanelHeight, width=PanelWidth,bg="white")
...
b <- b+ theme(legend.title=element_text(size=12),legend.text=element_text(size=14),legend.position = "bottom", legend.spacing.x = unit(0.5, 'cm'))                
legend <- grid_arrange_shared_legend(a,b,nrow=2,ncol=1,position="bottom")
ggsave("Panel-D.in-VPD.png",legend, path = FigDir, height=PanelHeight, width=PanelWidth,bg="white")
