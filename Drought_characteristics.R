...
ggsave("DroughtCharacteristics-1-Panel.png",g, path = FigDir, height=PanelHeight, width=PanelWidth, bg="white")
...
ggsave("DroughtCharacteristics-2-Panel.png",g, path = FigDir, height=PanelHeight, width=PanelWidth, bg="white")                      
